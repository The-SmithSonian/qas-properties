...
(function () {
    ...
    // Hides the full-screen Q loading animation once it has had
    // time to finish drawing. If this never runs (JS blocked or
    // slow), the loader would otherwise stay on screen forever.
    ...
    function renderServices() {
        ...
        if (services.length === 0) {
            ...
            const link = $('.nav a[href="#services"]');
        ...
        $("#serviceList").innerHTML = services.map(function (service, index) {

            return `
                <div class="feature reveal" style="--rd: ${index * 0.08}s">
                    <svg class="i" aria-hidden="true">
                        <use href="#i-${esc(service.icon || "shield")}"/>
                    </svg>
    ...
    function ensureHero() {
        ...
        // The first photo appears once the intro loader has had
        // time to finish; every photo after that is 30 seconds apart.
